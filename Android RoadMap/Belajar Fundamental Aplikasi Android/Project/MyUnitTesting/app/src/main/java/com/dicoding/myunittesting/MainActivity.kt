...
class MainActivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onClick(v: View) {
        ...
        val heigth = edtHeight.text.toString().trim()

        when{
            length.isEmpty() -> edtHeight.error = "Field ini tidak boleh kosong"
            width.isEmpty() -> edtWidth.error = "Field ini tidak boleh kosong"
            heigth.isEmpty() -> edtHeight.error = "Field ini tidak boleh kosong"
            else -> {
