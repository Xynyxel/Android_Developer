...
import com.dicoding.todoapp.setting.NearestTaskViewModel
...
class ViewModelFactory private constructor(private val taskRepository: TaskRepository) :
    ...
    override fun <T : ViewModel> create(modelClass: Class<T>): T =
        when {
            ...
            modelClass.isAssignableFrom(NearestTaskViewModel::class.java) -> {
                NearestTaskViewModel(taskRepository) as T
            }
