...
class RandomHabitAdapter(
    ...
    override fun onBindViewHolder(holder: PagerViewHolder, position: Int) {
        ...
        holder.bind(key, pageData, onClick)
    }
    ...
    inner class PagerViewHolder internal constructor(itemView: View) :
        ...
        fun bind(pageType: PageType, pageData: Habit, clickListener: (Habit) -> Unit) {
            ...
            if(pageType == PageType.HIGH){
                pagerIvPriority.setImageResource(R.drawable.ic_priority_high)
            }else if(pageType == PageType.MEDIUM){
                pagerIvPriority.setImageResource(R.drawable.ic_priority_medium)
            }else{
                pagerIvPriority.setImageResource(R.drawable.ic_priority_low)
            }
            btnOpenCount.setOnClickListener { onClick(pageData) }
        }
    }
}
